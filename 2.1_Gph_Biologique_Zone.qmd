...
ggsave(sprintf("%s%s_Species_Occr_List20.tiff",wdgraph,etude), 
       plot = dp, width = 10, height = 8, dpi=600)
...
print(bp)
ggsave(sprintf("%s%s %s.tiff",wdgraph,etude,titre),
       plot = bp, width = 12, height = 6, dpi=600)
bp1<-bp + 
...
print(bp)
ggsave(sprintf("%s%s %s.tiff",wdgraph,etude,titre),
       plot = bp, width = 15, height = 15, dpi=600)
...
print(bp)
ggsave(sprintf("%s%s %s.tiff",wdgraph,etude,titre), 
       plot = bp, width = 10, height = 10, dpi=600)
...
for (sp in spe){ #sp=1
  ...
  if (length(answ)>1 ){
    ...
    ggsave(sprintf("%s%s/%s_Bxp_%s_Ans.tiff",
           ...
           plot = bp, width = 16, height = 6, dpi=600)
  }}
