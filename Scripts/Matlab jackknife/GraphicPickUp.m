function varargout = GraphicPickUp(varargin)

%GraphicPickUp  digitize data from image.
%   GraphicPickUp with no input or output arguments allows the user to
...
%   
%   ACQDATA = GraphicPickUp with one output argument returns the X- and
%   Y- values of the graphically selected data in the array ACQDATA.
%   The user is not prompted to save the data to file.
%
%   GraphicPickUp(FILENAME) with one input argument FILENAME is used to 
