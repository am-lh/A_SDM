...
plot_rq<-map2(rqdata$pl_rq_po_sel,tmp_sdm_comb_sel_l,
            ~ map2(.x,.y[names(.x)],
              ~.x + labs(title=.y$analysis) ) ) #; plot_rq$Biomass$RQ2int_11112
plot_nlrq<-map2(nlrqdata$pl_rq_po_sel,tmp_sdm_comb_sel_l,
            ~ map2(.x,.y[names(.x)],
              ~.x + labs(title=.y$analysis)) )
plot_rqbs<-map2(rqbsdata$pl_rq_po_sel,tmp_sdm_comb_sel_l,
            ~ map2(.x,.y[names(.x)],
              ~.x + labs(title=.y$analysis)) ) 

pl_tmp<- pmap(list(plot_rq,plot_nlrq,plot_rqbs,tmp_sdm_comb_sel_l) ,
