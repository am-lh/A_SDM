...
ggsave(filename= sprintf("%sfig-map.tiff",wdgraph), 
       tm_study_map, width = 10,  height = 7, dpi=my.dpi) #
```
...
tm_study_map_html<-
  ...
  tm_layout(legend.show=FALSE)
tm_study_map_html
tmap_save(tm_study_map_html, dpi=my.dpi, 
...
ggsave(sprintf("%s%s/fig-mars_corr.tiff",wdgraph,espece),
       plot = pl_mars_corr, width = 16, height = 9, dpi=my.dpi)
...
iwalk(pl_des_gt,
  ~ggsave(sprintf("%s%s/fig-bio_struc_%s.tiff",wdgraph,espece,.y),
       plot = .x, width = 14, height = 7, dpi=my.dpi) )
...
iwalk(pl_mars_gt,
  ~ggsave(sprintf("%sHMS_R/fig-hms_struc_%s.tiff",wdgraph,.y),
       plot = .x, width = 14, height = 7, dpi=my.dpi) )
...
ggsave(sprintf("%sHMS_R/mars_st_board.tiff", wdgraph),
...
iwalk(pl_mars_map, ~tmap_save(.x$all, dpi=my.dpi, height=2, asp=0, #width=20,
...
tmap_save(tm_mars_gb, dpi=my.dpi,
